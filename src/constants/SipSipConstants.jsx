export const SIP_SETTINGS_FIELDS = [
  { label: 'SIP Address of WAN', type: 'select', key: 'sipWan', options: ['Lan 1:192.168.1.101'] },
  ...
  { label: 'IP Call In First Route', type: 'select', key: 'ipCallRoute', options: ['IP to PSTN'] },
  { label: 'Soft-switch to be Connected', type: 'select', key: 'softSwitch', options: ['Others'] },
  { label: 'Hide CallerID', type: 'select', key: 'hideCallerId', options: ['Not Hidden'] },
  { label: 'Obtain CallerID from', type: 'select', key: 'obtainCallerId', options: ['Username of From Field'] },
  { label: 'Obtain CalleeID from', type: 'select', key: 'obtainCalleeId', options: ["'Request' Field"] },
  { label: 'Send CalleeID from', type: 'select', key: 'sendCalleeId', options: ["'To' Field"] },
  { label: 'Asserted Identity Mode', type: 'select', key: 'assertedId', options: ['Disable'] },
  { label: 'Prack Send Mode', type: 'select', key: 'prackSend', options: ['Require'] },
  { label: 'DisplayName', type: 'select', key: 'displayName', options: ['Hide']},
  { label: 'UserName', type: 'select', key: 'userName', options: ['Change Caller'], default: 'Change Caller' },
  { label: 'Sip Address', type: 'select', key: 'sipAddress', options: ['IPv4']},
  ...
  { label: 'Multiple Audio Selection', type: 'select', key: 'audioSelection', options: ['RTP/Audio'] },
