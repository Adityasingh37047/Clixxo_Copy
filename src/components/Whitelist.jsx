...
import { WHITELIST_TABLE_COLUMNS, WHITELIST_CALLEE_TABLE_COLUMNS } from '../constants/WhitelistConstants';
...
const Whitelist = () => {
  ...
  const [modalType, setModalType] = useState('caller'); // 'caller' or 'callee'
  const [modalData, setModalData] = useState({ groupNo: '0', noInGroup: '1', idValue: '' });
  const [callerChecked, setCallerChecked] = useState([]); // array of indices
  const [calleeChecked, setCalleeChecked] = useState([]); // array of indices
      ...
      <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
        ...
        <div style={{ width: '50%' }}>
          ...
          <div style={tableContainerStyle}>
            <div style={blueBarStyle}>CallerID Whitelist</div>
        ...
        <div style={{ width: '50%' }}>
          ...
          <div style={tableContainerStyle}>
            <div style={blueBarStyle}>CalleeID Whitelist</div>
            <div className="custom-scroll-x" style={{ height: 400, overflowY: 'auto', width: '100%' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'auto' }}>
                <thead>
                  <tr>
