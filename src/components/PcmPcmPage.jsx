    ...
    <div className="bg-white min-h-screen w-full p-0 m-0">
      <div className="max-w-7xl mx-auto py-6 px-2 sm:px-4">
        ...
        <div className="overflow-x-auto w-full">
          <table className="w-full min-w-[900px] bg-white border-collapse border-2 border-[#888]">
            <thead>
              <tr>
      ...
      <Dialog open={modalOpen} onClose={closeModal} maxWidth="xs" fullWidth>
        <DialogTitle className="bg-gradient-to-b from-[#23272b] to-[#6e7a8a] text-white text-center font-semibold text-lg">Modify PCM Info</DialogTitle>
