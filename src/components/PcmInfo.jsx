...
const PcmInfo = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto font-sans text-sm p-4">
      ...
      <div className="w-full h-9 bg-gradient-to-b from-[#d0ecff] via-[#7ecbfa] to-[#3b8fd6] rounded-t-lg flex items-center justify-center font-semibold text-base text-gray-800 shadow mb-0">
        <span>PCM Info</span>
      </div>
        ...
        <div className="bg-white p-4 md:p-6">
          <div className="space-y-3">
            {PCM_FIELDS.map((field) => (
              <div key={field.key} className="flex flex-col md:flex-row items-center justify-between gap-2 md:gap-0">
